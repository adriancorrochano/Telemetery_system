...
class DisplayManager {
  ...
  public:
    ...
    void drawTelemetry(int bpm, float gForce, float slope, float temp, bool wifiOk, bool bleOk) {
      u8g2.clearBuffer();
      ...
      u8g2.setCursor(5, 45);
      if(bpm > 0) u8g2.print(bpm); else u8g2.print("--");
      u8g2.setFont(u8g2_font_helvB08_tr);
      u8g2.print(" bpm");

      // FISICA
      u8g2.setCursor(5, 70);
      u8g2.print("G: "); u8g2.print(gForce, 2);
      
      u8g2.setCursor(65, 70);
      u8g2.print("Slp: "); u8g2.print(slope, 0); u8g2.print("%");
